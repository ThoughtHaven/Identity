...
namespace ThoughtHaven.AspNetCore.Identity.Passwords
{
    public class PwnedPasswordStrengthValidator : IPasswordStrengthValidator
    {
        ...
        public async Task<Result<UserMessage>> Validate(Password password)
        {
            ...
            return !insecure ? new Result<UserMessage>()
                : new UserMessage("This password is insecure because it was exposed in an online data breach. You'll need a stronger password to protect your account. You can learn more at https://haveibeenpwned.com.");
        }
    }
}